  ...
  return (
    <div className="">
      ...
      <div className="mt-20 w-fit m-auto lg:mb-0">
        ...
        <input name="i1" type="text" placeholder="From date in format YYYY-MM-DD" value={nd} onChange={(e)=> setNd(e.target.value)} />
          <input name="i2" type="text" placeholder="To date in format YYYY-MM-DD" value={ed} onChange={(e)=> setEd(e.target.value)} />
